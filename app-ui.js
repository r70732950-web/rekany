...
    saveCurrentScrollPositionCore(); // 1. Cihê scrollê tomar dike
...
    // ***********************************************
    // *** GORANKARI 1: (Çareseriya popup scroll) ***
    // (پێش ئەوەی پۆپئەپەکە نیشان بدەیت، پەنجەرەکە دەباتەوە سەرەوە)
    window.scrollTo({ top: 0, behavior: 'instant' });
    // ***********************************************
...
        // ***********************************************
        // *** GORANKARI 2: (Çareseriya popstate) ***
        // (Koda kevin hate rakirin)
        btn.onclick = () => {
            // 1. Fîltera ku em dixwazin tomar dikin
...
                search: ''
            };
            // 2. Tenê popupê digire (ev 'popstate' çalak dike)
            closeCurrentPopup();
        };
        // ***********************************************
...
            // ***********************************************
            // *** GORANKARI 3: (Kontrolkirina fîltera çaverêkirî) ***
            if (state.pendingFilterNav) {
                console.log("Popstate: Cîbicîkirina fîltera çaverêkirî...");
                
                // 1. Em fîltera nû cîbicî dikin
                // (Niha em li rûpela malê ne û scroll vegeriyaye cihê xwe)
                await navigateToFilterCore(state.pendingFilterNav);
                
                // 2. Em UI nû dikin û diçin serî (ji ber ku fîlterek nû ye)
                await updateProductViewUI(true, true);
                
                // 3. Em guherbarê paqij dikin
                state.pendingFilterNav = null; 

            } else if (!cameFromPopup && !cameFromPage) {
            // ***********************************************
