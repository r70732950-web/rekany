...
    if (!mainCatId || mainCatId === 'all' || !subCatId || subCatId === 'all') return []; // Check added for 'all'
    try {
...
// *** گۆڕانکاری لێرە: زیادکردنی db و fetchSubSubcategories بۆ export ***
export {
    state, // Export the mutable state object
    handleLogin, handleLogout, // Authentication
    fetchCategories, fetchSubcategories, fetchSubSubcategories, // <-- fetchSubSubcategories لێرە زیادکرا
    fetchProductById, fetchProducts, fetchPolicies, fetchAnnouncements, fetchRelatedProducts, fetchContactMethods, // Data fetching
