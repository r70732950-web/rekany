...
    renderRelatedProducts(product);
    ...
    // ÇARESERÎ: Ev rêz piştrast dike ku her carê ku hûrguliyên hilberek nû vedibe, pel ji serî ve dizivire jor.
    const productSheet = document.getElementById('productDetailSheet');
    if (productSheet) {
