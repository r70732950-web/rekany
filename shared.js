// ===================================================================
//          فایلی هاوبەش (Shared)
// ئەم فایلە زانیاری و فەنکشنە هاوبەشەکانی تێدایە
// ===================================================================
...
function t(lang, key, replacements = {}) {
    let translation = translations[lang][key] || translations['ku_sorani'][key] || key;
...
// Exportـکرنا هەموو تشتێن هاوبەش
export { db, auth, messaging, t, showNotification, translations };
