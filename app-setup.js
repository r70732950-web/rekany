...
// [ 💡 نوێ ] initializeFirestore زیادکرا بۆ چارەسەری کێشەی ئینتەرنێت
...
import { initializeFirestore, enableIndexedDbPersistence, collection, addDoc, doc, updateDoc, deleteDoc, onSnapshot, query, orderBy, getDocs, limit, getDoc, setDoc, where, startAfter, runTransaction } from "https://www.gstatic.com/firebasejs/9.15.0/firebase-firestore.js";
...
// [ 💡 چاککراوە ] بەکارهێنانی initializeFirestore لە جیاتی getFirestore
// ئەمە کێشەی ERR_QUIC_PROTOCOL_ERROR چارەسەر دەکات
