...
async function searchProductsInFirestore(searchTerm = '', isNewSearch = false) {
    // === BEŞA NÛ: KONTROLKIRINA NÎŞANDANA LAWERA SEREKÎ ===
    if (!searchTerm && currentCategory === 'all') {
        productsContainer.style.display = 'none';
        skeletonLoader.style.display = 'none';
        homepageSectionsContainer.style.display = 'block';
        renderHomepageSections(); // Nîşandana beşên nû
        return; 
    }
    
    homepageSectionsContainer.style.display = 'none';
    
    // === KODÊ KEVN JI VÊRÊ DEST PÊ DIKE ===
...
// ==================================================
// === FENKSÎYONÊN NÛ JI BO LAWERA SEREKÎ ===
// ==================================================
...
// === FENKSÎYONÊN NÛ JI BO KONTROLA ADMIN ===
