...
function createProductCardElement(product) {
    ...
    productCard.dataset.productId = product.id; // Important for admin actions
    ...
    productCard.addEventListener('click', (event) => {
        ...
        if (addToCartButton) {
            ...
            // This is handled by a single event listener in admin.js
        } else if (target.closest('.delete-btn')) {
            // This is also handled by a single event listener in admin.js
