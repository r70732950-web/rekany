...
// --- DOM Element Selections (Exported for admin.js) ---
...
function createProductCardElement(product) {
    ...
    productCard.addEventListener('click', (event) => {
        ...
        } else if (!target.closest('.edit-btn') && !target.closest('.delete-btn') && !target.closest('a')) {
...
function updateAdminUI(isAdmin) {
    ...
    const adminSections = [
        ...
        'adminPoliciesManagement',
        'adminSocialMediaManagement', 
...
onAuthStateChanged(auth, async (user) => {
    ...
    if (user && user.uid === adminUID) {
        ...
        try {
            ...
            console.error("Failed to load or initialize admin module:", error);
        }
