...
        update_success: "ئەپ ب سەرکەفتیانە هاتە نویکرن!",
        manage_banners_title: "رێکخستنا ڕیکلامان",
    },
    ar: {
...
        update_success: "تم تحديث التطبيق بنجاح!",
        manage_banners_title: "إدارة اللافتات الإعلانية",
    }
};
...
// =======================================================
// ===== فانکشنە نوێیەکانی بەڕێوەبردنی ڕیکلامەکان =====
// =======================================================
...
                        const subcategoriesQuery = collection(db, "categories", mainCatSelectForSubSub.value, "subcategories");
                        const q = query(subcategoriesQuery, orderBy("order", "asc"));
                        const querySnapshot = await getDocs(q);
                        
